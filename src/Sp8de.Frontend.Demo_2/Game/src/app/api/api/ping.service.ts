...
export class PingService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiPingGet(observe?: 'body', reportProgress?: boolean): Observable<string>;
    public apiPingGet(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<string>>;
    public apiPingGet(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<string>>;
    public apiPingGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<string>(`${this.basePath}/api/ping`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
